  ...
  return (
    <div className="bg-blue-300 w-full h-[90px] flex items-center justify-between px-4 md:px-10 relative">
      ...
      <Link to="/" onClick={() => setIsMenuOpen(false)}>
        <img
          className="w-[80px] md:w-[97px] h-[70px] md:h-[70px] mt-[7px] cursor-pointer"
          src={fmunblack}
          alt="FMUN Logo"
        />
      </Link>
      ...
      <div className="hidden md:block">
        <ul className="flex flex-row space-x-4 lg:space-x-6">
          <li>
            <Link to="/" className="text-white font-bold cursor-pointer font-sans text-lg lg:text-xl hover:text-gray-300 transition">
              Home
            </Link>
          </li>
          <li>
            <Link to="/about" className="text-white font-bold cursor-pointer font-sans text-lg lg:text-xl hover:text-gray-300 transition">
              About us
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/announcements" className="text-white font-bold cursor-pointer font-sans text-lg lg:text-xl hover:text-gray-300 transition">
              Announcements
            </Link>
          </li>
          <li>
